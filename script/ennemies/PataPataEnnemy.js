...
{
	var d = this.getHitbox().boxOrigin.getX() - this.game.ship.getHitbox().boxOrigin.getX() > 100;
	var distance = this.getHitbox().boxOrigin.getY() - this.game.ship.getHitbox().boxOrigin.getY();
