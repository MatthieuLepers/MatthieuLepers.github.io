class Rocket extends PlayerProjectile
{
	...
	static launchRockets(player)
	{
		...
		{
			var rocketUp = new Rocket('rocketUp_' + player.sprite.id + '_' + player.registeredProjectiles.size, player, 'up');
			player.registeredProjectiles.set(rocketUp.sprite.id, rocketUp);
			var rocketDown = new Rocket('rocketDown_' + player.sprite.id + '_' + (player.registeredProjectiles.size), player, 'down');
			player.registeredProjectiles.set(rocketDown.sprite.id, rocketDown);
