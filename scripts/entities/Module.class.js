class Module extends SpawnableEntity
{
	...
	shoot()
	{
		...
		{
			case 0:
				var bullet = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, 0);
				this.registeredProjectiles.set(bullet.sprite.id, bullet);
				break;
			case 1:
				var angleBullet1 = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, 20);
				angleBullet1.sprite.position.y += 6;
				this.registeredProjectiles.set(angleBullet1.sprite.id, angleBullet1);
				var angleBullet2 = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, -20);
				angleBullet2.sprite.position.y -= 6;
				this.registeredProjectiles.set(angleBullet2.sprite.id, angleBullet2);
				break;
			case 2:
				var angleBullet1 = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, 20);
				angleBullet1.sprite.position.y += 6;
				...
				angleBullet2.sprite.position.y -= 6;
				this.registeredProjectiles.set(angleBullet2.sprite.id, angleBullet2);
				var angleBullet3 = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, 90);
				angleBullet3.sprite.position.x -= 15;
				angleBullet3.sprite.position.y += 6;
				this.registeredProjectiles.set(angleBullet3.sprite.id, angleBullet3);
				var angleBullet4 = new ModuleAngleBullet('moduleshot' + this.registeredProjectiles.size, this, -90);
				angleBullet4.sprite.position.x -= 15;
				angleBullet4.sprite.position.y -= 6;
				this.registeredProjectiles.set(angleBullet4.sprite.id, angleBullet4);
				break;
		}
	}
